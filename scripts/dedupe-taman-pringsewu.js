...
for (const item of targetItems) {
  ...
  // Merge drink dual pricing fields if present
...
if (removeIds.size === 0) {
  console.log('No duplicates found for Taman Pringsewu.');
  process.exit(0);
}
...
console.log(`Removed ${removeIds.size} duplicate items. Taman Pringsewu count: ${beforeCount} -> ${afterTarget.length}`);
