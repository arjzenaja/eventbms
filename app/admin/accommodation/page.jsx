          ...
          <div className="px-4 py-6 sm:px-0">
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  title="Export Data Penginapan ke CSV"
                >
                  <span>📊</span>
                  Export
                </button>
                ...
                <button 
                  onClick={() => {
                    console.log('Current accommodations state:', accommodations);
                    console.log('Filtered accommodations:', filteredAccommodations);
                    alert(`Total penginapan: ${accommodations.length}\nTersaring: ${filteredAccommodations.length}`);
                  }}
                ...
                <button 
                  onClick={async () => {
                    if (confirm('Migrate types untuk standardisasi data penginapan? Ini akan membuat backup otomatis.')) {
                      try {
                  ...
                  title="Migrate Types Data Penginapan"
                >
                  <span>🔄</span>
                  Migrate Types
                </button>
            ...
            <div className="bg-gray-100 p-4 mb-4 rounded-md">
              <div className="text-sm text-gray-600">
                ...
                Total Penginapan: <span className="font-mono">{accommodations.length}</span> | 
                Filtered: <span className="font-mono">{filteredAccommodations.length}</span>
                {filterType !== 'all' && (
                  ...
                  {filteredAccommodations.length === 0 ? (
                    <tr>
                      <td colSpan="7" className="px-6 py-4 text-center text-gray-500">
                        Tidak ada data penginapan yang ditemukan
                      </td>
                    </tr>
                  ) : (
                      ...
                      <tr key={item.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                            {item.type === 'hotel' ? 'Hotel' : 
                             item.type === 'resort' ? 'Resort' : 
                             item.type === 'villa' ? 'Vila' : 
                             item.type === 'guesthouse' ? 'Guesthouse' : 
                             item.type === 'homestay' ? 'Homestay' : 
                             item.type === 'hostel' ? 'Hostel' : item.type}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          {item.star_rating ? '⭐'.repeat(item.star_rating) : '-'}
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center space-x-2">
                            <Link
                              href={`/admin/accommodation/${item.id}/view`}
                            ...
                            <Link
                              href={`/admin/accommodation/${item.id}`}
