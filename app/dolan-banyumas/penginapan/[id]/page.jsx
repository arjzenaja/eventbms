              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {destination.entrance_fee && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiMoney className="text-2xl text-green-400" />
                    <div>
                      <p className="text-sm text-gray-400">Harga per Malam</p>
                ...
                {destination.contact && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiPhone className="text-2xl text-green-400" />
                    <div>
                ...
                {destination.created_at && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiTime className="text-2xl text-green-400" />
                    <div>
