    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Dolan Banyumas Tidak Ditemukan</h1>
          <p className="text-gray-400 mb-6">Dolan Banyumas yang Anda cari tidak ditemukan.</p>
          <button 
        ...
        <div className="w-full max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {destination.price_range && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiMoney className="text-2xl text-orange-400" />
                    <div>
                      <p className="text-sm text-gray-400">Range Harga</p>
                      <p className="text-white font-medium">{destination.price_range}</p>
                    </div>
                  </div>
                )}
                ...
                {destination.contact && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiPhone className="text-2xl text-orange-400" />
                    <div>
                ...
                {destination.address && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiMap className="text-2xl text-orange-400" />
                    <div>
                ...
                {destination.opening_hours && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm text-gray-400">Jam Buka</p>
                      <p className="text-white font-medium">{destination.opening_hours}</p>
                    </div>
                  </div>
                )}
              ...
              {destination.cuisine && (
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Jenis Masakan</h3>
                  <div className="inline-block bg-orange-600/20 text-orange-300 px-4 py-2 rounded-full text-sm font-medium">
                    {destination.cuisine}
                  </div>
                </div>
              )}
