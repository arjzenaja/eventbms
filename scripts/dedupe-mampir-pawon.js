...
if (removeIds.size === 0) {
  console.log('No duplicates found for Mampir Pawon.');
  process.exit(0);
}
...
console.log(`Removed ${removeIds.size} duplicate items. Mampir Pawon count: ${beforeCount} -> ${afterTarget.length}`);
