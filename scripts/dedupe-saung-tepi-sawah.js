...
for (const item of targetItems) {
  ...
  // Merge price variants if applicable
...
if (removeIds.size === 0) {
  console.log('No duplicates found for Saung Tepi Sawah.');
  process.exit(0);
}
...
console.log(`Removed ${removeIds.size} duplicate items. Saung Tepi Sawah count: ${beforeCount} -> ${afterTarget.length}`);
