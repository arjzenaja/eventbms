...
export default function AdminDestinations() {
  ...
  useEffect(() => {
    const fetchDestinations = async () => {
      try {
        ...
        setError('Terjadi kesalahan saat mengambil data objek wisata');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const filteredDestinations = destinations.filter(destination => {
    ...
    const normalizeType = (t) => (t === 'objek-wisata' ? 'wisata-alam' : t);
    const matchesType = filterType === 'all' || normalizeType(destination.type) === filterType;
  ...
  const handleDeleteDestination = async (destinationId) => {
    ...
    try {
      ...
      alert('Terjadi kesalahan saat menghapus objek wisata');
    }
  };
        ...
        <div className="bg-white shadow-sm border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-6">
              <h1 className="text-3xl font-bold text-gray-900">Objek Wisata</h1>
              <Link 
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <option value="wisata-alam">Objek Wisata</option>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            {destination.type === 'wisata-alam' ? 'Wisata Alam' : 
                             ...
                             destination.type === 'wisata-religi' ? 'Wisata Religi' : destination.type}
                          </span>
                        </td>
