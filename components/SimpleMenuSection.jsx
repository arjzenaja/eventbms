...
const SimpleMenuSection = ({ destinationTitle, destinationId, destinationSlug }) => {
  ...
  const dynamicCategories = [
    ...
    { id: 'main', name: 'Menu Utama', count: menus.filter(menu => !menu.name.toLowerCase().includes('es') && !menu.name.toLowerCase().includes('wedang')).length },
    { id: 'drinks', name: 'Minuman', count: menus.filter(menu => menu.name.toLowerCase().includes('es') || menu.name.toLowerCase().includes('wedang')).length }
  ];
  ...
  const filteredMenus = activeCategory === 'all' 
    ...
    : activeCategory === 'main'
    ? menus.filter(menu => !menu.name.toLowerCase().includes('es') && !menu.name.toLowerCase().includes('wedang'))
    : menus.filter(menu => menu.name.toLowerCase().includes('es') || menu.name.toLowerCase().includes('wedang'));
