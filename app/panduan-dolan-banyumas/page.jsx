  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-32">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-32 relative">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight animate-fade-in-up delay-200">
              ...
              <br />
              <span className="text-white animate-fade-in-up delay-400">Dolan Banyumas</span>
            </h1>
            
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-600">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12 animate-fade-in-up delay-800">
              ...
              <Link href="/dolan-banyumas" className="group">
                <button className="px-8 py-4 bg-white/10 text-white rounded-full text-lg font-semibold hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/30 flex items-center gap-3">
        ...
        {/* Table of Contents */}
        <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Link href="#beranda" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20 hover:border-blue-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-blue-300 transition-colors">Beranda</h3>
                      <div className="w-8 h-1 bg-blue-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Cara menggunakan halaman utama dan navigasi website</p>
              ...
              <Link href="#pencarian" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-green-500/10 to-green-600/10 hover:from-green-500/20 hover:to-green-600/20 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20 hover:border-green-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-green-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-green-300 transition-colors">Pencarian</h3>
                      <div className="w-8 h-1 bg-green-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Cara mencari destinasi dan menggunakan filter</p>
              ...
              <Link href="#destinasi" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 hover:from-purple-500/20 hover:to-purple-600/20 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-purple-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-purple-300 transition-colors">Destinasi</h3>
                      <div className="w-8 h-1 bg-purple-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Menjelajahi berbagai kategori destinasi wisata</p>
              ...
              <Link href="#detail" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 hover:from-orange-500/20 hover:to-orange-600/20 backdrop-blur-sm rounded-2xl p-6 border border-orange-500/20 hover:border-orange-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-orange-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-orange-300 transition-colors">Detail Destinasi</h3>
                      <div className="w-8 h-1 bg-orange-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Memahami informasi lengkap destinasi</p>
              ...
              <Link href="#booking" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-red-500/10 to-red-600/10 hover:from-red-500/20 hover:to-red-600/20 backdrop-blur-sm rounded-2xl p-6 border border-red-500/20 hover:border-red-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-red-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-red-300 transition-colors">Booking & Reservasi</h3>
                      <div className="w-8 h-1 bg-red-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Cara melakukan pemesanan dan reservasi</p>
              ...
              <Link href="#faq" className="group transform hover:scale-105 transition-all duration-300">
                <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/10 hover:from-cyan-500/20 hover:to-cyan-600/20 backdrop-blur-sm rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-cyan-500/20">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg group-hover:text-cyan-300 transition-colors">FAQ</h3>
                      <div className="w-8 h-1 bg-cyan-400 rounded-full group-hover:w-12 transition-all duration-300"></div>
                    </div>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">Pertanyaan yang sering diajukan</p>
        ...
        <div id="beranda" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 relative overflow-hidden mt-16">
          {/* Progress Indicator */}
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-6 mb-12">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-4xl font-bold text-white mb-3">Beranda & Navigasi</h2>
                <p className="text-gray-300 text-lg">Cara menggunakan halaman utama dan menu navigasi</p>
              </div>
            </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-2xl p-6 border border-white/20 hover:border-blue-400/30 transition-all duration-300 shadow-lg hover:shadow-xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">Menu Navigasi</h3>
                </div>
                <div className="space-y-6">
                  <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-blue-400/20 transition-all duration-300">
                    <div className="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                      <BiRightArrowAlt className="text-blue-400 text-sm" />
                    </div>
                    <div>
                      <span className="text-white font-semibold">Jelajahi:</span>
                      <span className="text-gray-300 ml-2">Menampilkan semua destinasi wisata</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-blue-400/20 transition-all duration-300">
                    <div className="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div>
                      ...
                      <span className="text-gray-300 ml-2">Informasi tentang Dolan Banyumas</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-blue-400/20 transition-all duration-300">
                    <div className="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div>
                      <span className="text-white font-semibold">Panduan Kami:</span>
                      <span className="text-gray-300 ml-2">Tutorial penggunaan website (halaman ini)</span>
                    </div>
                  </div>
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-2xl p-6 border border-white/20 hover:border-green-400/30 transition-all duration-300 shadow-lg hover:shadow-xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">Fitur Pencarian Cepat</h3>
                </div>
                <p className="text-gray-300 mb-6 text-lg">Di halaman beranda, Anda dapat:</p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    <span className="text-gray-300">Menggunakan search bar untuk mencari destinasi</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    <span className="text-gray-300">Memilih kategori destinasi langsung dari beranda</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
                    <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    <span className="text-gray-300">Melihat destinasi populer dan rekomendasi</span>
                  </div>
                </div>
              </div>
            </div>
            
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl p-8 border border-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-white">Tips Navigasi</h3>
              </div>
              <div className="space-y-8">
                <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-yellow-400/20 transition-all duration-300 group">
                  ...
                  <div>
                    <p className="text-white font-bold text-lg mb-2">Gunakan Menu Mobile</p>
                    <p className="text-gray-300">Di perangkat mobile, tap ikon menu (☰) untuk mengakses navigasi</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-yellow-400/20 transition-all duration-300 group">
                  <div className="w-10 h-10 bg-green-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div>
                    <p className="text-white font-bold text-lg mb-2">Scroll untuk Eksplorasi</p>
                    <p className="text-gray-300">Scroll ke bawah untuk melihat lebih banyak konten dan fitur</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-yellow-400/20 transition-all duration-300 group">
                  <div className="w-10 h-10 bg-green-500/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div>
                    <p className="text-white font-bold text-lg mb-2">Logo untuk Kembali</p>
                    <p className="text-gray-300">Klik logo Dolan Banyumas untuk kembali ke beranda</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="pencarian" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 mt-16">
          <div className="flex items-center gap-6 mb-12">
        ...
        <div id="destinasi" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 mt-16">
          <div className="flex items-center gap-6 mb-12">
        ...
        <div id="detail" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 mt-16">
          <div className="flex items-center gap-6 mb-12">
        ...
        <div id="booking" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 mt-16">
          <div className="flex items-center gap-6 mb-12">
        ...
        {/* FAQ Section */}
        <div id="faq" className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 mb-24 border border-white/10 mt-16">
          <div className="flex items-center gap-6 mb-12">
