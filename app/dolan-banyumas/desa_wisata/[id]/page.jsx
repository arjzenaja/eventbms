        ...
        <div className="w-full max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {/* Type Badge */}
              <div className="inline-block bg-teal-600 text-white px-4 py-2 rounded-full text-sm font-medium">
                {destination.type}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {destination.entrance_fee && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiMoney className="text-2xl text-teal-400" />
                    <div>
                      <p className="text-sm text-gray-400">Biaya Masuk</p>
                ...
                {destination.contact && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiPhone className="text-2xl text-teal-400" />
                    <div>
                ...
                {destination.address && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiMap className="text-2xl text-teal-400" />
                    <div>
                ...
                {destination.created_at && (
                  <div className="flex items-center gap-3 bg-white/5 p-4 rounded-lg">
                    <BiTime className="text-2xl text-teal-400" />
                    <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {destination.features.map((feature, index) => (
                      <span
                        key={index}
                        className="bg-teal-600/20 text-teal-300 px-3 py-1 rounded-full text-sm"
                      >
                        {feature}
                      </span>
                    ))}
